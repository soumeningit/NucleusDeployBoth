            ...
            <footer className="bg-[#5d646452]">
                <div className="mx-auto px-4 flex flex-col">
                    <div className="flex flex-row justify-evenly md:flex-row mt-9">
                        {/* Contact Information */}
                        <div className="mb-6 md:mb-0 gap-y-2">
                            <img src={logo} alt="logo-image" loading="lazy" className="h-28 w-28 rounded-full border-1 border-richblack-200" />
                            <h3 className="text-xl font-semibold">Contact Us</h3>
                            <p>Email: support@nucleus.com</p>
                        ...
                        <div className="flex flex-col mt-10">
                            ...
                            <ul className="space-y-2">
                                {courses.map((course, index) => (
                                    <li key={index}>
                                        <Link to={course.link} className="hover:underline">{course.name}</Link>
                                    </li>
                                ))}
                            </ul>
                        </div>
                        ...
                        <div className="flex flex-col mt-10">
                            ...
                            <ul className="space-y-2">
                                {languages.map((language, index) => (
                                    <li key={index}>
                                        <Link to={language.link} className="hover:underline">{language.name}</Link>
                                    </li>
                                ))}
                            </ul>
                        </div>
